    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			...
			<div class="navbar-header">
                ...
                <a class="navbar-brand" href="successC.php">Credit Committee</a>
            </div>
            <!-- /end, navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
							...
							<!--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////// KANI CHI ////////////////////////////////////////////////////////////////////////////////// -->
						<li>
                            <a href="successC.php?cont=loan"><i class="fa fa-rub fa-fw"></i> Loan for Approval</a>
                        </li>
						
						 <li>
                            <a href="successC.php?cont=loanList"><i class="fa fa-rub fa-fw"></i> List of Loans</a>
                        </li>
						<!--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////// HANTUD DRI ////////////////////////////////////////////////////////////////////////////////// -->
...
<!-- Search User ////////////////////////////////////////////////////////////////////////////////////////////////-->  
																	...
																	foreach($dataLoan as $dataloan) {?>
																		<tr class="odd gradeX">
																			...
																			<td style="width: 10%;">
																				...
																				<?php }?>
																			<td style="width: 10%;"><?php echo $dataloan->getApplicationNo(); ?></td>
																			<td style="width: 20%;"><?php   $app = $dataloan->getApplicationNo();
																											$command = new Command();
																											$datajoin = $command->joindata($app);
																											echo $datajoin->getFname();echo " "; echo $datajoin->getLname();?></td>
	...
	function confirmDeleteLoan(AppNo) {
		...
		if (answer) {
			...
			if(x)
				{
				location.href = "successC.php?conti=removeLoan&AppNo="+AppNo+"&Reason="+x;
				}
	...
	function ReleaseLoan(AppNo) {
		...
		if (answer) {
			location.href = "successC.php?conti=release&AppNo="+AppNo;
		} else {
			return;
		}
	}
	...
	function confirmEditLoan(AppNo) {
			location.href = "successC.php?contl=viewloan&ApplicationNo="+AppNo;
		}
	<!--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////// HANTUD DRI ////////////////////////////////////////////////////////////////////////////////// -->
