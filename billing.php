	...
	for($x=0;$x<$countdata;$x++)
	{
        ...
        $loanpID = $dataPayment[$x]->getpaymentNo();
                ...
                if($status != 'Paid Advance')
                {
                    ...
                    {
                        $status = 'Pending';
                        $command->updateStatusLoanP($status,$loanpID);
                    }
                }
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">  <!-- ito ang CENTER -->
            <div class="container-fluid ">
				...
				Loan Application # <?php echo $AppNo;?><br>
				Statement Date: <?php echo $day = date('M-d-Y');?>
				<br><br><br>
				<h3 class = "box">Current Charges</h3>
				<br>
				<table border="0" style="width:80%">
				  <tr>
					...
					<td><b><p align="right">Status</p></b></td>
				  </tr>
				<?php 
				for ($x=0;$x<$countdata;$x++)
				{
				...
				<tr>
					...
					<td><p align="right"><?php echo number_format($AmountArray[$x]/$TermArray[$x],2);?></p></td> 
					<td><p align="right"><?php echo number_format($InterestArray[$x],2);?></p></td>
					<td><p align="right"><?php if($dataPayment[$x]->getStatus() == "Paid Advance")
							{
								echo number_format($AmountArray[$x]/$TermArray[$x],2);
							}
							else if($dataPayment[$x]->getStatus() == "Overdue")
							{
							  echo number_format($AmountArray[$x]/$TermArray[$x] + $InterestArray[$x],2);
							}
							
							else
							{
							  echo number_format($AmountArray[$x]/$TermArray[$x] + $AmountArray[$x] * 0.02 * $TermArray[$x]/$TermArray[$x],2);
							}
							?></p></td>
					
							
					<td><p align="right"><?php echo $dataPayment[$x]->getStatus();?></p></td>
				...
				<table border="0" style="width:80%">
				<th class="box">Account Summary as of <?php echo $date = date('M-d-Y');?></th>
					<tr>
						<td></td>
						<td style="width: 10%;" align="right"><b><p>Amount</p><b></td>
						<td align="right"><b><p>Paid</p><b></td>
					<tr>
						<td><p>Loan Amount</p></td>
						<td align="right" style="width: 20%;"><p><?php echo number_format($Amount,2);?></p></td>
						<td></td>
					</tr>
					<tr>
						<td><p>Loan Interest</p></td><br>
						<td align="right" style="width: 20%;"><p><?php echo number_format($TempTotalInterest,2);?></p></td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="right"><p><?php echo number_format($Amount+$TempTotalInterest-$TempTotalAmount-$TempTotalAdvance,2);?></p></td>
				...
				<a id="Home" align="left" href="success.php?cont=Billing" type="submit" class="btn btn-primary col-sm-offset-0">Back</a>
				<?php }?>
				<?php if($_SESSION['Position'] == "Treasurer")
				{?>
				<input class="btn btn-primary" type="button" value="Print" onclick="window.print()" target="_blank" style="cursor:pointer">
				<a id="Home" align="left" href="successT.php?cont=Billing" type="submit" class="btn btn-primary col-sm-offset-0">Back</a>
				<?php }?>
